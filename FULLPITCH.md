...
| May 2026 | Railway cron for agents set to `*/10 * * * *`; MLR agent adds live match-page score checks and lineup-to-PlayerSeason ingestion for match days. |
