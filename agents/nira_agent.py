...
def run_nira_agent() -> dict[str, Any]:
    ...
    try:
        ...
        relevant_indexes = batch_relevance_check(
            articles,
            client,
            prompt_intro="You are filtering NIRA women's college rugby news articles.",
            relevant_description="about NIRA, NCAA women's college rugby, women's college rugby teams, results, rankings, players, or postseason",
